    ...
    <div className="sticky top-0 z-20 border-b border-gray-200 bg-white px-6">
      {spaceName && (
        <div className="pt-4 pb-2 flex items-center gap-2">
          <span className="w-6 h-6 rounded bg-indigo-600 text-white text-xs font-bold flex items-center justify-center">
        ...
        {tabs.map(t => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2.5 text-[13px] font-medium whitespace-nowrap border-b-2 transition-colors ${active
