  ...
  return (
    <div className="w-full h-full bg-white flex flex-col font-sans select-none overflow-hidden relative">
      ...
      <div className="h-14 border-b border-slate-200 px-5 flex items-center justify-between shrink-0">
        <div>
          <h2 className="text-lg  text-slate-800">Task Board</h2>
            ...
            <div key={i} className={`w-[260px] flex flex-col ${col.bg} rounded-xl p-3 max-h-full`}>
              <div className="flex items-center justify-between mb-3 px-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-slate-200 text-slate-500 text-[9px]  px-1.5 py-0.5 rounded-full">{col.count}</span>
                </div>
                {i === 0 && (
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col gap-3 pb-2">
                {col.tasks.map((task, j) => (
                  <div key={j} className="bg-white p-3 rounded shadow-sm border border-slate-200 hover:border-red-300 transition-colors cursor-grab group">
                    ...
                    {task.progress && (
                      <div className="pl-5 mb-3">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-[9px]  text-red-600">{task.progress}%</span>
                        </div>
