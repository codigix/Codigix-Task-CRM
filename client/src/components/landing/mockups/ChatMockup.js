  ...
  return (
    <div className="w-full h-full bg-white flex font-sans select-none overflow-hidden relative">
      ...
      <div className="w-56 bg-slate-50 border-r border-slate-200 flex flex-col h-full shrink-0">
        <div className="h-14 border-b border-slate-200 flex items-center px-4  text-slate-800 shadow-sm shrink-0">
          Team Chat
        </div>
        <div className="flex-1 overflow-y-auto py-3 no-scrollbar">
          ...
          <div className="mb-4">
            <div className="px-4 flex justify-between items-center mb-1.5 group cursor-pointer">
              <span className="text-[10px]  text-slate-500 uppercase tracking-widest">Channels</span>
            ...
            {['general', 'sales-team', 'marketing-campaigns', 'announcements'].map((ch, i) => (
              <div key={i} className={`flex items-center gap-2 px-4 py-1.5 cursor-pointer text-xs font-medium ${i === 1 ? 'bg-red-50 text-red-600 border-r-2 border-red-600' : 'text-slate-600 hover:bg-slate-100'}`}>
                ...
                {ch}
                {i === 1 && <span className="ml-auto bg-red-600 text-white text-[9px]  px-1.5 rounded-full">3</span>}
              </div>
            ))}
          </div>
          ...
          <div>
            <div className="px-4 flex justify-between items-center mb-1.5 group cursor-pointer">
              <span className="text-[10px]  text-slate-500 uppercase tracking-widest">Direct Messages</span>
              <Plus size={12} className="text-slate-400 group-hover:text-red-500" />
            </div>
            {[
      ...
      <div className="flex-1 flex flex-col bg-white h-full relative">
        <div className="h-14 border-b border-slate-200 flex justify-between items-center px-6 shrink-0 bg-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className=" text-slate-800 text-sm">sales-team</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 no-scrollbar">
          ...
          <div className="flex gap-3">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className=" text-slate-800 text-xs">Mike R.</span>
                <span className="text-[10px] text-slate-400">10:24 AM</span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed bg-slate-50 p-3 rounded rounded-tl-none border border-slate-100">
          ...
          <div className="flex gap-3">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className=" text-slate-800 text-xs">Sarah J.</span>
          ...
          {/* Message 3 */}
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded border border-slate-200 shrink-0 bg-red-100 text-red-600 flex items-center justify-center  text-xs">
              ME
            </div>
            <div className="w-full">
              <div className="flex items-baseline gap-2 mb-1">
                <span className=" text-slate-800 text-xs">You</span>
                <span className="text-[10px] text-slate-400">Just now</span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed bg-red-50 p-3 rounded rounded-tl-none border border-red-100 inline-block">
        ...
        <div className="p-4 bg-white border-t border-slate-200 shrink-0">
          <div className="border border-slate-200 rounded overflow-hidden focus-within:border-red-400 focus-within:ring-1 focus-within:ring-red-400 transition-all bg-slate-50">
            <input
              type="text"
