  ...
  return (
    <div className="w-full h-full bg-slate-50 flex flex-col font-sans select-none overflow-hidden relative">
      ...
      <div className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-5">
        <div>
          <h2 className="text-lg  text-slate-800 flex items-center gap-2">
            Sales Pipeline <span className="bg-red-100 text-red-600 text-[10px] px-2 py-0.5 rounded-full ">Q4</span>
          </h2>
      ...
      <div className="flex-1 overflow-hidden px-5 pb-5">
        <div className="bg-white rounded border border-slate-200 h-full flex flex-col shadow-sm">
          <div className="grid grid-cols-12 gap-3 p-3 border-b border-slate-200 bg-slate-50/80 text-[10px]  text-slate-500 uppercase tracking-wider sticky top-0">
          ...
          <div className="flex-1 overflow-y-auto">
            {deals.map((deal, i) => (
              <div key={i} className="grid grid-cols-12 gap-3 p-3 border-b border-slate-100 items-center hover:bg-slate-50 transition-colors group cursor-pointer text-xs">
                ...
                <div className="col-span-2 text-right  text-slate-700 flex items-center justify-end gap-1">
                  {deal.value}
                </div>
                ...
                <div className="col-span-1 flex flex-col items-center justify-center gap-1">
                  <span className="text-[10px]  text-slate-600">{deal.prob}%</span>
