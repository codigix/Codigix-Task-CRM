        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded border border-slate-200 p-4 flex flex-col shadow-sm">
              ...
              <span className="text-2xl font-bold text-slate-800 mb-1">{kpi.value}</span>
        ...
        <div className="grid grid-cols-3 gap-4 flex-1">
          ...
          <div className="col-span-2 bg-white rounded border border-slate-200 shadow-sm flex flex-col min-h-[250px]">
            ...
            <div className="flex-1 overflow-y-auto p-2">
              <div className="grid grid-cols-12 gap-2 p-2 border-b border-slate-100 text-[9px] font-bold text-slate-400 uppercase">
              ...
              {[
                ...
                <div key={i} className="grid grid-cols-12 gap-2 p-2 border-b border-slate-50 items-center hover:bg-slate-50 text-xs">
                  ...
                  <div className="col-span-2 flex justify-center">
                    <span className={`text-[8px] font-bold px-2 py-0.5 rounded-full ${camp.status === 'Active' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}`}>
                      {camp.status}
                    </span>
                  </div>
                  ...
                  <div className="col-span-3 flex flex-col items-end justify-center gap-1">
                    <span className="font-bold text-slate-700">{camp.leads}</span>
              ...
              {[
                ...
                <div key={i} className="flex flex-col gap-1.5">
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="font-bold text-slate-800">{src.val}</span>
                  </div>
