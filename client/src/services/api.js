...
export const estimationsAPI = {
  ...
  convertToProposal: (id, data) => apiService.post(`/estimations/${id}/convert-to-proposal`, data),
  convertToInvoice: (id, data) => apiService.post(`/estimations/${id}/convert-to-invoice`, data),
  duplicate: (id) => apiService.post(`/estimations/${id}/duplicate`),
  revise: (id, data) => apiService.post(`/estimations/${id}/revise`, data),
  getRevisions: (id) => apiService.get(`/estimations/${id}/revisions`),
  getActivities: (id) => apiService.get(`/estimations/${id}/activities`),
